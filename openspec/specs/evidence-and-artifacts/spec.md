...
### Requirement: Evidence layers remain separate
...
### Requirement: Strong baselines are reported honestly
...
### Requirement: Failure cases are part of the evidence package
...
### Requirement: Thesis-facing artifacts stay synchronized
