...
### Requirement: Variable-specific nominal models
...
### Requirement: Device power calibration precedes spatial correction
...
### Requirement: Trilinear correction is a low-order correction
...
### Requirement: Dense grid values are estimates unless simulation truth is declared
