...
### Requirement: Non-networked appliance impact learning
...
### Requirement: Interpretable model remains the primary estimator
...
### Requirement: Interface layers are not the core scientific contribution
...
### Requirement: Recommendation is counterfactual ranking
