# Sensing Node Delta Specification

## ADDED Requirements

### Requirement: SND-010 Physical nodes support thesis sensor roles
...
### Requirement: SND-011 Furniture-aware deployment uses expanded node count
...
### Requirement: SND-012 Validation nodes use validation-grade temperature humidity sensors
...
### Requirement: SND-013 Reference-grade calibration package is tracked separately
...
### Requirement: SND-014 Node BOM cost is tracked by deployment level
...
### Requirement: SND-015 DHT11 is low-cost input, not high-precision reference
...
### Requirement: SND-016 Light sensor should produce calibrated lux
