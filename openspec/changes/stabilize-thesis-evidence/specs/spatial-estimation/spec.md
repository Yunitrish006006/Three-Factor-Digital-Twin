# Spatial Estimation Delta Specification
...
### Requirement: SPE-008 Sensor roles prevent evaluation leakage
...
### Requirement: SPE-009 Fan state is an experimental condition
...
### Requirement: SPE-010 Fan-aware nodes cover airflow path and dead zone
...
### Requirement: SPE-011 Free-space domain is explicit
...
### Requirement: SPE-012 Estimators use a common contract
...
### Requirement: SPE-013 Two-dimensional triangulation is height-specific
...
### Requirement: SPE-014 Three-dimensional interpolation uses valid tetrahedra
...
### Requirement: SPE-015 Cell-IDW fuses valid local estimates
...
### Requirement: SPE-016 Occlusion policy depends on metric
