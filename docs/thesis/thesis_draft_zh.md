...
值得注意的是，候選對照文獻中已確認的 CU-BEMS / AC predictive control 結果僅報告溫度預測指標：validation RMSE 0.08、MAE 0.03，且 case-study 平均 RMSE 為 0.1600、0.1591、0.1621、0.1627。該文獻未提供濕度或照度指標，因此本研究目前僅將其作為溫度比較的參考，濕度與照度比較仍需另尋資料來源。
